...
import authRoutes from './Routes/AuthRoute.js';  // Capitalize 'R' and 'T'
import characterRoutes from './Routes/CharacterRoute.js';
import reasonRoutes from './Routes/ReasonRoute.js';
import imageRoutes from './Routes/ImageRoutes.js';
import tagRoutes from './Routes/TagsRoutes.js';  // Capitalize 'T'
import chatRoutes from './Routes/ChatRoutes.js';
import personaRoutes from './Routes/PersonaRoutes.js';
import idRoutes from './Routes/IdRoutes.js';  // Keep the same as filename
