  ...
  return (
    <div className="main">
      ...
      <div className="preview-container relative p-6">
        <div className="Preview-text mt-[50px] absolute top-[4300px]">
      ...
      <div className="info px-6 relative" style={{ top: '200px' }}>
  <div className="infotext mb-8">
    <h1 className="text-3xl font-bold text-gray-800">Why Choose PandAI?</h1>
    <p className="text-lg text-gray-600 mt-4">
      Discover the ultimate AI-powered roleplay experience where your stories come to life with the help of PandAI’s advanced technology.
    </p>
  </div>
  ...
  <div className="cards grid grid-cols-1 md:grid-cols-3 gap-6">
    <div className="card p-6 bg-black text-white shadow-lg rounded-lg">
      ...
      <p className="mt-4 text-gray-300">
        Utilize cutting-edge AI tools to create compelling narratives and characters with ease.
      </p>
    </div>
    <div className="card p-6 bg-black text-white shadow-lg rounded-lg">
      <h2 className="text-xl font-semibold">Endless Creativity</h2>
      <p className="mt-4 text-gray-300">
        Explore endless possibilities for storytelling, bringing your imagination to life.
      </p>
    </div>
    <div className="card p-6 bg-black text-white shadow-lg rounded-lg">
      <h2 className="text-xl font-semibold">Panda-Powered Experience</h2>
      <p className="mt-4 text-gray-300">
