  ...
  return (
    <div className="preview-container">
      ...
      <div className="Buttons absolute top-[470px]">
        <button className="text-white text-xl h-[47px] w-[200px] rounded-lg shadow-2xl bg-gradient-to-r from-[#FFCBBB] to-[#B22801]">
          Explore
        </button>

        <button className="create bg-black text-white text-xl h-[47px] w-[200px]  rounded-lg shadow-2xl ml-4 outline outline-1 outline-yellow-500 hover:h-[50px] hover:w-[210px]">
          Create
        </button>
      </div>
    </div>
