  ...
  return (
    <div className="main">
      <div className="fixed top-0 left-0 w-full bg-black bg-opacity-40 p-4 z-50">
        <div className="flex justify-between items-center w-full max-w-screen-xl mx-auto px-4 bg-opacity-40">
          ...
          <div className="flex items-center space-x-6">
            <button className="flex items-center text-white font-baloo user-select-none  hover:text-[#E03201] transition">
            ...
            <button className="text-white hover:text-[#E03201] transition user-select-none">Login</button>
            <button className="bg-[#E03201] text-white px-4 py-1 rounded-md hover:bg-[#b02501] transition user-select-none">
              Sign Up
            </button>
          </div>
        </div>
