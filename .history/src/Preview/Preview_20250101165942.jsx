...
<div className="absolute top-0 left-0 w-full bg-black bg-opacity-80 p-4 z-50">
  <div className="flex justify-end items-center space-x-4 max-w-screen-xl mx-auto">
