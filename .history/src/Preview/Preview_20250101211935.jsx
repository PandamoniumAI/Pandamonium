    ...
    <div className="main">
      ...
      <div className="info px-6 relative" style={{ top: "700px" }}>
        <div className="infotext mb-8 text-white">
              ...
              (title, index) => (
                ...
                >
                  ...
                  <div className="image-container mt-4">
                    {index === 0 ? (
                      <img src={Chatcard} alt="Roleplay" className="w-full rounded-[25px]" />
                    ) : index === 1 ? (
                      <img src={Book} alt="Creator Tools" className="w-full rounded-[25px]" />
                    ) : (
                      <img src={Roleplay} alt="Community" className="w-full rounded-[25px]" />
                    )}
                  </div>
                </div>
              )
          ...
          <div className="footer bg-black py-6 flex flex-col items-center justify-center text-center">
  <img className="w-8 h-8 mb-4" src={Animal} alt="Logo" />
  <h1 className="text-2xl font-bold font-baloo text-white">
    Pand<span className="text-[#E03201]">AI</span>
  </h1>
