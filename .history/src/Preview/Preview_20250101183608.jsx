              ...
              (title, index) => (
                ...
                >
                  ...
                  <div className="image-container mt-4">
                    {index === 0 ? (
                      <img src="../assets/Roleplay Card.png" alt="Roleplay" className="w-full rounded-[25px]" />
                    ) : index === 1 ? (
                      <img src="../assets/Creator Tools Card.png" alt="Creator Tools" className="w-full rounded-[25px]" />
                    ) : (
