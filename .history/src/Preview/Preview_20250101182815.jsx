...
export default function Preview() {
  ...
  {["Multiple Character Roleplays", "Tools for Creators", "Community-Driven No Filter"].map(
    (title, index) => (
      <div
        key={index}
        className="card relative overflow-hidden flex flex-col justify-between w-[284px] h-[477px] rounded-[25px] outline-2 outline-transparent outline-offset-4"
      >
        ...
        {/* Gradient outline */}
        <div className="absolute inset-0 rounded-[25px] outline-2 outline-transparent outline-offset-4 bg-gradient-to-br from-[#BF18C2] via-[#6B1C8F] to-[#1D0375] pointer-events-none"></div>
      </div>
    )
  )}
</div>
