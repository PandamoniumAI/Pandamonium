  ...
  {["Multiple Character Roleplays", "Tools for Creators", "Community-Driven No Filter"].map(
    (title, index) => (
      <div
        ...
        style={{
          boxShadow: '0 0 0 4px transparent', // Add space for shadow
          backgroundClip: 'content-box', // Ensures the background does not overlap with the shadow
        }}
      >
        ...
        <div
          className="gradient-outline absolute inset-0 -z-10 rounded-[25px]"
          style={{
