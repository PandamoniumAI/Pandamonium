...
export default function Preview() {
  return (
    <div className="preview-container relative p-6">
      <button className="absolute right-12 bg-[#E03201] w-[67px] h-[30px] p-[8px] rounded-[8px] gap-[8px]">
      Sign up
      </button>
      <button className="absolute right-[125px]">
      Login
      </button>
      ...
      <div className="Buttons absolute top-[470px] flex space-x-4 mb-8">
      ...
      <div> {/*make the card here go to the right*/}
