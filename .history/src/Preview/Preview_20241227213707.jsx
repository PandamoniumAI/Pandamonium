  ...
  return (
    <div className="preview-container">
      ...
      <div className="preview-text mt-[50px]">
        <h1 className="text-4xl font-bold mb-4 text-white tracking-[0.5px] w" style={{ lineHeight: '59.4px' }}>Where Your Stories Find Their Voice and Characters Come Alive</h1>
