...
export default function Preview() {
  return (
    <div className="preview-container relative p-6 flex-row-reverse">
      <div className="topbar sticky bg-black bg-opacity-50 px-4 py-2 flex justify-end">
        <button className="text-white font-baloo mr-4">
        ...
        <button className="bg-[#E03201] py-2 px-4 rounded-[8px]">
          Sign up
        </button>
