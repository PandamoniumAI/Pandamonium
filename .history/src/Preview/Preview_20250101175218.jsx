...
export default function Preview() {
  ...
  <div className="cards grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="card p-6 bg-black text-white shadow-lg rounded-lg">
      ...
      <p className="mt-4">
      Experience unfiltered chats tailored to your preferences, refine AI responses with feedback, shape platform features with community input, and customize personas to your liking.      </p>
    </div>
  </div>
</div>
</div>
