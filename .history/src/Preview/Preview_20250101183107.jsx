      ...
      {["Multiple Character Roleplays", "Tools for Creators", "Community-Driven No Filter"].map(
        (title, index) => (
          <div
            ...
            onMouseMove={(e) => handleCardHover(e, e.currentTarget)} // Apply hover effect
            onMouseLeave={(e) => resetCardHover(e.currentTarget)} // Reset hover effect
          >
            <div
              ...
              style={{
                ...
                bottom: 0,
                borderRadius: '25px',
                padding: '2px', // To create the effect of the outline
              }}
            />
