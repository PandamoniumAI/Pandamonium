...
export default function Preview() {
  return (
    <div className="preview-container relative p-6 flex-row-reverse">z
        <div className="button-container relative">
          <button className="absolute right-12 bg-[#E03201] w-[67px] h-[30px] rounded-[8px] gap-[8px] bottom-[-12px]">
            Sign up
          </button>
          <button className="absolute right-[130px] bottom-[-9px]">
            Login
          </button>
          <button className="chats absolute text-white h-[14px] w-[60px] right-[190px] flex items-center bottom-[-10px]">
            <FaComments className="mr-2 size-[24px]" /> Chats
          </button>
          <button className="chats absolute text-white h-[14px] w-[70px] right-[290px] flex items-center bottom-[-10px]">
            <FaCompass className="mr-2 size-[24px]" /> Explore
          </button>
          <button className="chats absolute text-white h-[14px] w-[60px] right-[390px] flex items-center bottom-[-10px]">
