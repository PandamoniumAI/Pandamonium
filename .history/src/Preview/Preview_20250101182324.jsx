...
export default function Preview() {
  ...
  {["Multiple Character Roleplays", "Tools for Creators", "Community-Driven No Filter"].map(
    (title, index) => (
      <div
        key={index}
        className="card relative overflow-hidden flex flex-col justify-between w-[284px] h-[477px] rounded-[25px] outline-none"
      >
        ...
        {/* Animated outline */}
        <div className="absolute inset-0 rounded-[25px] pointer-events-none animate-outline"></div>
      </div>
    )
  )}
</div>
