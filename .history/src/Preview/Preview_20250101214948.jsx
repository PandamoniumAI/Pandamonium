...
export default function Preview() {
  ...
  <div className="Preview-text mt-[50px] absolute top-[200px] animate__animated animate__fadeInUp">
    ...
    <p className="text-[18px] text-gray-300 leading-[27px] tracking-[0.5px] w-[500px] mb-8 animate__animated animate__fadeIn animate__delay-2s">
      Redefine AI roleplay with advanced tools, endless creativity, and a
      panda-powered experience that sets a new standard.
    </p>
  </div>

  <div className="Buttons absolute top-[500px] flex space-x-4 mb-8 animate__animated animate__fadeInUp animate__delay-3s">
