  ...
  return (
    <div className="preview-container">
      ...
      <div className="Preview-text mt-[50px] absolute top-[200px]">
        <p className="text-2xl text-gray-300  font-bold mb-4 tracking-[0.5px] w-[500px] leading-[59.4px]">Where Your Stories Find Their Voice and Characters Come Alive</p>
        <p className="text-xl text-gray-300 leading-[27px] ">Redefine AI roleplay with advanced tools, endless creativity, and a panda-powered experience that sets a new standard.</p>
      </div>
    </div>
  );
}
