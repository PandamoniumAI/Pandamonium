...
export default function Preview() {
  ...
  <div className="flex justify-between items-center w-full max-w-screen-xl mx-auto px-4">
    <div
      className="flex items-center space-x-4 cursor-pointer animate__animated animate__fadeIn animate__delay-1s animate__zoomIn"
      onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
    >
      <img className="w-8 h-8 animate__animated animate__bounceIn" src={Animal} alt="Logo" />
      <h1 className="text-2xl font-bold font-baloo text-white animate__animated animate__fadeInUp animate__delay-1s">
    ...
    <div className="flex items-center space-x-6 animate__animated animate__fadeIn animate__delay-2s">
      <button className="flex items-center text-white font-baloo hover:text-[#E03201] transition transform hover:scale-105 duration-300">
      ...
      <button className="text-white hover:text-[#E03201] transition transform hover:scale-105 duration-300">
        Login
      </button>
      <button className="bg-[#E03201] text-white px-4 py-1 rounded-md hover:bg-[#b02501] transition transform hover:scale-105 duration-300">
        Sign Up
      </button>
    </div>
  </div>
