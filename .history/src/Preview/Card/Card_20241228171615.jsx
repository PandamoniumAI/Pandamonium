        ...
        <div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-4">
                {Object.entries(CharacterCards).map(([key, character]) => (
                    <div
                        className="border- w-[194px] h-[323px] border-[0.5px] border-gray-300 rounded-[15px] shadow-lg transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-xl hover:translate-y-[-10px] cursor-pointer bg-transparent overflow-hidden group"
                        key={key}
