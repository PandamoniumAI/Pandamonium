...
<div className="flex flex-wrap gap-5 justify-evenly">
  {Object.entries(CharacterCards).map(([key, character]) => (
    ...
    >
      ...
      />
      <div className="p-4" style={{ backgroundColor: '#C62D01' }}>
        <h2 className="text-white text-xl font-semibold mb-2">{character.info.name}</h2>
        <p className="text-white text-sm opacity-80 mb-3">{character.info.preview}</p>
