            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-4">
                {Object.entries(CharacterCards).map(([key, character]) => (
                    ...
                    >
                        ...
                        <div className="p-4 bg-gradient-to-r from-red-700 via-red-600 to-red-500 rounded-b-[15px]">
                            <h2 className="absolute left-4 top-4 text-sm text-white font-semibold mb-2 drop-shadow-lg">{character.info.name}</h2>
                            <p className="text-white text-xs opacity-90 mb-4 text-center drop-shadow-md">{character.info.preview}</p>
