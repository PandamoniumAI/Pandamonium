...
export default function Preview() {
  ...
  {["Multiple Character Roleplays", "Tools for Creators", "Community-Driven No Filter"].map(
    (title, index) => (
      <div
        key={index}
        className="card relative overflow-hidden flex flex-col justify-between w-[284px] h-[477px] rounded-[25px] border-2 border-transparent bg-clip-border"
      >
        ...
        <div className="absolute inset-0 rounded-[25px] border-2 border-transparent bg-gradient-to-br from-[#BF18C2] via-[#6B1C8F] to-[#1D0375] pointer-events-none"></div>
      </div>
    )
  )}
</div>
