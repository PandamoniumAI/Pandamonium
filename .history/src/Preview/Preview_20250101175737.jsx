...
export default function Preview() {
  ...
  <div className="card p-6 bg-gradient-to-r from-[#E03201] to-[#611600] text-white shadow-xl rounded-lg hover:shadow-2xl transition-shadow duration-300">
    <h2 className="text-2xl font-semibold mb-4">Multiple Character Roleplays</h2>
    <p className="text-lg">
  ...
  <div className="card p-6 bg-gradient-to-r from-[#E03201] to-[#611600] text-white shadow-xl rounded-lg hover:shadow-2xl transition-shadow duration-300">
    <h2 className="text-2xl font-semibold mb-4">Tools for Creators</h2>
    <p className="text-lg">
  ...
  <div className="card p-6 bg-gradient-to-r from-[#E03201] to-[#611600] text-white shadow-xl rounded-lg hover:shadow-2xl transition-shadow duration-300">
    <h2 className="text-2xl font-semibold mb-4">Community-Driven No Filter</h2>
    <p className="text-lg">
