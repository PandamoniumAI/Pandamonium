...
export default function Preview() {
    ...
    <div className="main">
      ...
      <div className="info px-6 relative bg-black" style={{ top: "700px" }}>
        <div className="infotext mb-8 text-white">
          ...
          <div className="Footer bg-black py-8 flex items-start pl-6 mt-10">
  <img className="w-8 h-8 mr-6 mb-4" src={Animal} alt="Logo" />
  <div className="flex flex-col mr-36 mt-6">
  ...
  <div className="Quicklinks mr-36 mt-6">
    ...
    <ul className="list-none pl-0 mt-4">
      <li className="text-white hover:text-[#E03201] transition duration-300">
        <a href="#">Home</a>
      </li>
      <li className="text-white hover:text-[#E03201] transition duration-300">
        <a href="#">Explore</a>
