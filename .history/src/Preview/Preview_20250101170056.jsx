...
<div className="absolute top-0 left-0 w-full h-16 bg-black bg-opacity-80 z-50 flex items-center px-8">
  <div className="flex justify-between items-center w-full max-w-screen-xl mx-auto">
    ...
    <div className="flex items-center space-x-4">
      ...
      <button className="bg-[#E03201] text-white px-4 py-2 rounded-md">
        Sign up
      </button>
    </div>
  </div>
