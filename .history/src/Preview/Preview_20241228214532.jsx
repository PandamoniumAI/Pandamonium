...
<h1 className="preview-title text-2xl font-bold absolute top-4 left-[50px] text-white font-baloo">PandAI</h1>
      ...
      <div className="Buttons absolute top-[500px] flex space-x-4 mb-8">
        ...
        <button className="create bg-black text-white text-xl h-[47px] w-[200px] rounded-lg shadow-2xl outline outline-1 outline-gradient-to-r from-[#FFCBBB] to-[#B22801] hover:bg-gradient-to-r hover:from-[#FFCBBB] hover:to-[#B22801] hover:text-black transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-[#B22801]/50 hover:shadow-lg relative overflow-hidden group">
