  ...
  return (
    <div className="preview-container">
      ...
      <div className="Preview-text mt-[50px] absolute top-[200px]">
        ...
        <p className="text-sm text-gray-300 leading-[27px] ">Redefine AI roleplay with advanced tools, endless creativity, and a panda-powered experience that sets a new standard.</p>
      </div>
    </div>
  );
}
