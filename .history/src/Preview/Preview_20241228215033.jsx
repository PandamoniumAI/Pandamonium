...
<img className="preview-image w-6 h-6 absolute bottom-[5px]" src={Animal} alt="Animal" />
<h1 className="preview-title text-2xl font-bold absolute top-4 left-[50px] text-white font-baloo">PandAI</h1>
      <div className="Preview-text mt-[50px] absolute top-[200px]">
        <p className="text-4xl text-gray-300 font-bold mb-6 tracking-[0.5px] w-[500px]">Where Your Stories Find Their Voice and Characters Come Alive</p>
        <p className="text-[18px] text-gray-300 leading-[27px] tracking-[0.5px] w-[500px] mb-8">Redefine AI roleplay with advanced tools, endless creativity, and a panda-powered experience that sets a new standard.</p>
      </div>
      ...
      <div className="Buttons absolute top-[500px] flex space-x-4 mb-8">
        ...
        <button className="create relative text-white text-xl h-[47px] w-[200px] rounded-lg shadow-2xl bg-black hover:text-black transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-[#B22801]/50 hover:shadow-lg group overflow-hidden">
  <span className="absolute inset-0 bg-gradient-to-r from-[#FFCBBB] to-[#611600] -m-[2px] rounded-lg group-hover:blur-sm"></span>
  <span className="relative z-10 flex items-center justify-center h-full w-full bg-black rounded-lg">Create</span>
</button>
v
