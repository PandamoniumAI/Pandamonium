  ...
  return (
    <div className="preview-container">
      ...
      <div className="Preview-text mt-[50px] absolute top-[200px]">
        <p className="text-Xl text-gray-300 leading-[59.4px] font-bold mb-4 tracking-[0.5px] w-[500px] ">Where Your Stories Find Their Voice and Characters Come Alive</p>
