    ...
    <div className="preview-container relative p-6 flex-row-reverse">
      <div className="absolute top-0 right-0 p-4">
        <div className="button-container sticky bg-black ">
          ...
          <button className="chats absolute text-white h-[14px] w-[60px] right-[190px] flex items-center text-baloo">
            <FaComments className="mr-2 size-[24px]" /> Chats
          </button>
          <button className="chats absolute text-white h-[14px] w-[70px] right-[290px] flex items-center text-baloo">
            <FaCompass className="mr-2 size-[24px]" /> Explore
          </button>
          <button className="chats absolute text-white h-[14px] w-[60px] right-[390px] flex items-center text-baloo">
