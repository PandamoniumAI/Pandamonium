...
export default function Preview() {
    ...
    <div className="main">
      ...
      <div className="info px-6 relative bg-black" style={{ top: "700px" }}>
        <div className="infotext mb-8 text-white">
          ...
          <div className="Footer bg-black py-6 flex items-start pl-6 mt-10">
  ...
  <div className="Quicklinks mr-[350px] mt-6">
    <h1 className="text-2xl font-bold font-baloo text-white">Quick Links</h1>
    <ul className="list-none pl-0 mt-2">
      <li className="text-white hover:text-[#E03201] transition">
        <a href="#">Home</a>
      </li>
      <li className="text-white hover:text-[#E03201] transition">
        <a href="#">Explore</a>
  ...
  <div className="guide mr-12 mt-6">
    <h1 className="text-2xl font-bold font-baloo text-white">Guide</h1>
    <ul className="list-none pl-0 mt-2">
      <li className="text-white hover:text-[#E03201] transition">
  ...
  <div className="legal mr-12 mt-6">
    <h1 className="text-2xl font-bold font-baloo text-white">Legal</h1>
    <ul className="list-none pl-0 mt-2">
      <li className="text-white hover:text-[#E03201] transition">
