...
export default function TOS() {
    ...
    return (
      <>
        <h2 className="text-center font-bold text-3xl mb-6 animate__animated animate__fadeIn">
          <b>TERMS AND CONDITIONS</b>
        </h2>
        <p className="animate__animated animate__fadeIn animate__delay-1s">Last updated: 2030-06-12</p>
        <p>
          1. <b>Introduction</b>
        </p>
  
        <p>
          Welcome to <b>Pandamonium Ai</b> (“Company”, “we”, “our”, “us”)!
        </p>
  
        <div>
          <p>
            These Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at <b>http://www.pandai.us</b> (together or
            individually “Service”) operated by <b>Pandamonium Ai</b>.
          </p>
          <p>
          ...
          <p>
            ...
            <b>whitzscott@gmail.com</b> so we can try to find a solution. These
          ...
          <p>
            ...
            Pandamonium Ai cancels it. You may cancel your Subscription renewal
            either through your online account management page or by contacting
            whitzscott@gmail.com customer support team.
          </p>
          <p>
            A valid payment method is required to process the payment for your
            subscription. You shall provide Pandamonium Ai with accurate and
            ...
            information, you automatically authorize Pandamonium Ai to charge all
            Subscription fees incurred through your account to any such payment
            instruments.
          </p>
          <p>
            Should automatic billing fail to occur for any reason, Pandamonium Ai
          ...
          <p>
            Pandamonium Ai may, at its sole discretion, offer a Subscription with
          ...
          <p>
            ...
            Trial, you will not be charged by Pandamonium Ai until Free Trial has
          ...
          <p>
            At any time and without notice, Pandamonium Ai reserves the right to
          ...
          <p>
            Pandamonium Ai, in its sole discretion and at any time, may modify
          ...
          <p>
            Pandamonium Ai will provide you with a reasonable prior notice of any
          ...
          <p>
            Pandamonium Ai has the right but not the obligation to monitor and
            edit all Content provided by users.
          </p>
          <p>
            In addition, Content found on or through this Service are the property
            of Pandamonium Ai or used with permission. You may not distribute,
          ...
          <p>
            ...
            property of Pandamonium Ai and its licensors. Service is protected by
            ...
            without the prior written consent of Pandamonium Ai.
          </p>
          <p>
          ...
          <p>
            ...
            to whitzscott@gmail.com, with the subject line: “Copyright
          ...
          <p>
            You can contact our Copyright Agent via email at whitzscott@gmail.com.
          </p>
          <p>
            17. <b>Error Reporting and Feedback</b>
          </p>
          <p>
            You may provide us either directly at whitzscott@gmail.com or via
          ...
          <p>
            ...
            that are not owned or controlled by Pandamonium Ai.
          </p>
          <p>
            Pandamonium Ai has no control over, and assumes no responsibility for
          ...
          <p>
            ...
            laws of Philipines, which governing law applies to agreement without
        ...
        <button className="agree border-black hover:text-green-500 hover:bg-green-500">
          I agree And will follow the terms and conditions of the website
        </button>
        <button className="disagree last:border-black hover:text-green-500 hover:bg-green-500">
