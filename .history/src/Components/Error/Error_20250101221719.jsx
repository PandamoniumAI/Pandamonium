      ...
      <>
        <section className="flex items-center justify-center h-screen bg-gradient-to-r from-blue-400 to-blue-600 p-8">
          <div className="container flex flex-col items-center justify-center px-6 mx-auto my-8">
            <div className="max-w-lg text-center bg-white rounded-lg shadow-2xl p-8 transform transition duration-500 hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-2xl font-semibold text-black md:text-3xl mb-4 animate__animated animate__fadeIn animate__delay-1.5s">
                Oops! We couldn't find that page.
              </p>
              <p className="mt-4 mb-8 text-lg text-black animate__animated animate__fadeIn animate__delay-2s">
